...
<body id="page-top">
        ...
        <form class="form-inline my-2 my-lg-0 mr-lg-2">
          <div class="input-group">
            <select id="lstGrupo" name="lstGrupo" class="form-control" onchange="cambiarGrupo();">
              @for ($i = 0; Session::get('array_grupos') !== null && $i < count(Session::get('array_grupos')); $i++) @if (Session::get('grupo_id')==Session::get('array_grupos')[$i]->idarea)
  ...
  <div id="wrapper">
    <ul class="sidebar navbar-nav">
      @for ($i = 0; Session::get('array_menu') && $i < count(Session::get('array_menu')); $i++) @if (Session::get('array_menu')[$i]->id_padre == 0)
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="{{ Session::get('array_menu')[$i]->idmenu }}">
            @for ($j = 0; $j < count(Session::get('array_menu')); $j++) @if(Session::get('array_menu')[$j]->id_padre == Session::get('array_menu')[$i]->idmenu)
